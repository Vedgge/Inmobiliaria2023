document.addEventListener("DOMContentLoaded", function () {
  ...
  if (nombre.trim() === "") {
    ...
    if (email.trim() === "") {
      mostrarError("emailFormErrorContacto", "Por favor, ingrese su dirección de correo electrónico.");
      esValido = false;
    } else if (!isValidEmail(email)) {
      mostrarError("emailFormErrorContacto", "Por favor, ingrese una dirección de correo electrónico valida.");
      esValido = false;
    } else {
